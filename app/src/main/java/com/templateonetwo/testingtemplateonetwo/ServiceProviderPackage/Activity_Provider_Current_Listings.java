...
public class Activity_Provider_Current_Listings extends AppCompatActivity {
    @Override
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.ic_new_project:
                        Intent intent0 = new Intent(Activity_Provider_Current_Listings.this, MainActivity.class);
                    ...
                    case R.id.ic_find_contractor:
                        Intent intent2 = new Intent(Activity_Provider_Current_Listings.this, Activity_Find_Contractors.class);
                        startActivity(intent2);
                        break;


                    case R.id.ic_chat:
                        Intent intent3 = new Intent(Activity_Provider_Current_Listings.this, Activity_Chat.class);
                    ...
                    case R.id.ic_settings:
                        Intent intent4 = new Intent(Activity_Provider_Current_Listings.this, Activity_Settings.class);
