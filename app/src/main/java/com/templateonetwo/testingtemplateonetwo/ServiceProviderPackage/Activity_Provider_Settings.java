...
public class Activity_Provider_Settings extends AppCompatActivity {

    private static final String TAG = "Activity_Settings";
    private static final int ACTIVITY_NUM = 4;
    private Context mContext = Activity_Provider_Settings.this;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.ic_new_project:
                        Intent intent0 = new Intent(Activity_Provider_Settings.this, MainActivity.class);
                        startActivity(intent0);
                        break;

                    case R.id.ic_current_listings:
                        Intent intent1 = new Intent(Activity_Provider_Settings.this, Activity_Current_Listings.class);
                        startActivity(intent1);
                        break;


                    case R.id.ic_find_contractor:
                        Intent intent2 = new Intent(Activity_Provider_Settings.this, Activity_Find_Contractors.class);
                        startActivity(intent2);
                        break;


                    case R.id.ic_chat:
                        Intent intent4 = new Intent(Activity_Provider_Settings.this, Activity_Chat.class);
